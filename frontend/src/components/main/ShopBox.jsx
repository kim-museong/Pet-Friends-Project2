      ...
      <ShopShowBox theme={String(theme)}>
        <Slider {...settings}>
          ...
          <div>
            <h3 className="img3">
              출처
              <a href="https://kr.freepik.com/free-photo/cute-scottish-straight-gray-cat-hunting-and-playing_22549232.htm#page=7&query=%EA%B3%A0%EC%96%91%EC%9D%B4%20%EC%9A%A9%ED%92%88&position=32&from_view=search&track=ais">
                Freepik
              </a>
            </h3>
          </div>
          <div>
            <h3 className="img4">
              출처
              <a href="https://kr.freepik.com/free-photo/close-up-on-beautiful-cat_21195532.htm#page=2&query=%EA%B3%A0%EC%96%91%EC%9D%B4%20%EC%9E%A5%EB%82%9C%EA%B0%90&position=38&from_view=search&track=ais">
                Freepik
              </a>
            </h3>
          </div>
          <div>
            <h3 className="img5">
              출처
              <a href="https://kr.freepik.com/free-photo/close-up-on-pet-lifestyle_20519522.htm#page=5&query=%EA%B3%A0%EC%96%91%EC%9D%B4%20%EC%9E%A5%EB%82%9C%EA%B0%90&position=8&from_view=search&track=ais">
                Freepik
              </a>
            </h3>
          </div>
